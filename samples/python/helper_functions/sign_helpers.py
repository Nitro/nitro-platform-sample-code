...
def create_signature_envelope(sign_client, documents: list[dict], employee_name: str, employee_email: str) -> tuple[str, list[str]]:
...
def add_signature_fields_to_documents(sign_client, envelope_id: str, document_ids: list[str], participant_id: str) -> None:
...
def send_and_monitor_envelope(sign_client, envelope_id: str, email: str, timeout_minutes: int = 60) -> str:
...
def monitor_envelope(sign_client, envelope_id: str, timeout_minutes: int = 60) -> str:
...
def download_signed_document(sign_client, envelope_id: str, output_folder: Path, document_name: str) -> Path:
