...
def main():
    ...
    if len(sys.argv) < 4:
        print("Usage: python redact_by_keyword.py <input_pdf> <output_pdf> <keyword1> [keyword2 ...]")
        print("Example: python redact_by_keyword.py document.pdf redacted.pdf 'confidential' 'secret'")
        sys.exit(1)
    ...
    try:
        ...
        if not text_boxes:
            print("ℹ️  No keyword matches found - copying original file")
